...
G4AssemblyVolume* CloverDetector::ConstructSegmCloverAssembly(G4String name){
	...
	if(!logicShape7){			// shielded condition
		...
		/*G4VisAttributes * tempVisAttr = new G4VisAttributes(false);
		logicShape6->SetVisAttributes(tempVisAttr);*/
		...
		//yRot5->rotateY(67.5*deg);

		//assemblySegClover->AddPlacedVolume(logicShape7,pos5,yRot5);		
...
G4AssemblyVolume* CloverDetector::ConstructSegCrystalAssembly(G4String name){
	...
	/*
	Segment1 =   new G4LogicalVolume(Seg1, Ge_mat, name + "_Segment1");	
  	Segment2 =   new G4LogicalVolume(Seg2, Ge_mat, name + "_Segment2");	
  	Segment3 =   new G4LogicalVolume(Seg3, Ge_mat, name + "_Segment3");	
  	Segment4 =   new G4LogicalVolume(Seg4, Ge_mat, name + "_Segment4");	
  	Segment5 =   new G4LogicalVolume(Seg5, Ge_mat, name + "_Segment5");	
  	Segment6 =   new G4LogicalVolume(Seg6, Ge_mat, name + "_Segment6");	
  	Segment7 =   new G4LogicalVolume(Seg7, Ge_mat, name + "_Segment7");	
  	Segment8 =   new G4LogicalVolume(Seg8, Ge_mat, name + "_Segment8");	
	*/

	Segment1 =   new G4LogicalVolume(Seg3, Ge_mat, name + "_Segment3");	
  	Segment2 =   new G4LogicalVolume(Seg4, Ge_mat, name + "_Segment4");	
  	Segment3 =   new G4LogicalVolume(Seg1, Ge_mat, name + "_Segment1");	
  	Segment4 =   new G4LogicalVolume(Seg2, Ge_mat, name + "_Segment2");	
  	Segment5 =   new G4LogicalVolume(Seg7, Ge_mat, name + "_Segment7");	
  	Segment6 =   new G4LogicalVolume(Seg8, Ge_mat, name + "_Segment8");	
  	Segment7 =   new G4LogicalVolume(Seg5, Ge_mat, name + "_Segment5");	
  	Segment8 =   new G4LogicalVolume(Seg6, Ge_mat, name + "_Segment6");
...
//	logicShape3 =   new G4LogicalVolume(InsideCylinder1, Ge_mat, name + "_DeadLayer");	
...
//	logicShape2 = new G4LogicalVolume(GeCrystal7, Ge_mat, name);
...
//	logicShape1 =   new G4LogicalVolume(DeadGeCrystal8, Ge_mat, name + "_DeadLayer");	
...
//	logicShape4 =   new G4LogicalVolume(BackDeadLayer5, Ge_mat, name + "_DeadLayer");	
