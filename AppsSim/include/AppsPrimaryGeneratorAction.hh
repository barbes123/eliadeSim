...
public:
	...
	void SetDecaySchedule();			  // sets up the number of particles to be emited per second
...
private:
	...
	std::vector<G4int> DecaySchedule = std::vector<G4int>(1000000, 0); // Decay schedule for the number of particles per second
